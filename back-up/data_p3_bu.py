...
if __name__ == "__main__":
    input_file_path = 'data_p2_fixed.xlsx'
    output_file_path = 'data_p3.xlsx'
    # In chữ màu xanh lá
    base_column_name = input("\033[92mNhập tên cột chứa đáp án đúng: \033[0m")
